...
/* 자동증가 컬럼에 임의의 값(여기서 2)을 삽입할 수 있으나 사용하지 
않는 것이 좋다. */
...
/*
	페이지처리를 위해 게시물의 범위를 정할 때 Oracle은 rownum의
...
-- 게시물 수정하기
UPDATE board SET title='수정해볼까요?', content='수정은 수정일뿐..ㅋㅋ'
WHERE num=2;
...
INSERT INTO board(title, content, id, bname)
	VALUE('여긴 공기사항','내용없음', 'kosmo', 'notice');
